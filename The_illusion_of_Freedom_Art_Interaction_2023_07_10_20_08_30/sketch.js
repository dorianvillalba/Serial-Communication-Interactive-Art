...
function preload() {
  ...
  cloudSound = loadSound('cloud-sound.mp3');
    music = loadSound('minecraft-music.mp3');
}
...
let frameWidth = 20;
let frameHeight = 40; // Add frame height
playerX = constrain(playerX, frameWidth, width - frameWidth - 100); // Subtract bird width from the right edge
playerY = constrain(playerY, frameWidth, height - frameHeight - 100); // Subtract bird height from the bottom edge
...
// Rest of the code with Cloud and Sun classes stays the same.
